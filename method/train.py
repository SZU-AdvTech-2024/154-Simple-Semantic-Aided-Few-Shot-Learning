...
from models.SemAlign import SemAlign
...
from utils.utils import Cosine_classifier, count_95acc, transform_val_cifar, \
    count_kacc, transform_val_224_cifar
...
if __name__ == '__main__':
    ...
    parser.add_argument('--backbone', type=str, default='resnet12',
                        choices=['resnet12', 'resnet50', 'swin'])
    ...
    args.work_dir = './result/{}_{}_{}_{}_{}_{}'.format(args.backbone, args.dataset, args.mode, args.text_type,
                                                        args.center,
                                                        args.shot)
    ...
    if args.dataset == 'FC100':
        args.val = r'C:\workspace\code\PythonProject\SemFew\dataset\FC100\FC1001\val'
        args.train = r'C:\workspace\code\PythonProject\SemFew\dataset\FC100\FC1001\train'
        train_dataset = ImageFolder(args.train,
                                    transform=transform_val_cifar if args.backbone == 'resnet12' or args.backbone == 'resnet50' else transform_val_224_cifar)
        val_dataset = ImageFolder(args.val,
                                  transform=transform_val_cifar if args.backbone == 'resnet12' or args.backbone == 'resnet50' else transform_val_224_cifar)
    elif args.dataset == 'CIFAR-FS':
        args.val = r'C:\workspace\code\PythonProject\SemFew\dataset\CIFAR-FS\cifar-fs\val'
        args.train = r'C:\workspace\code\PythonProject\SemFew\dataset\CIFAR-FS\cifar-fs\train'
        train_dataset = ImageFolder(args.train,
                                    transform=transform_val_cifar if args.backbone == 'resnet12' or args.backbone == 'resnet50' else transform_val_224_cifar)
        val_dataset = ImageFolder(args.val,
                                  transform=transform_val_cifar if args.backbone == 'resnet12' or args.backbone == 'resnet50' else transform_val_224_cifar)
    ...
    proto_center = torch.load('./center/center_{}_{}.pth'.format(args.dataset, args.backbone))[args.center]
    ...
    if 'ImageNet' in args.dataset:
        semantic = torch.load('./semantic/imagenet_semantic_{}_{}.pth'.format(args.mode, args.text_type))[
            'semantic_feature']
    else:
